...
yield, and borrow against them. LAX is built directly on Aave's Pool contract —
not a wrapper, not a simulation. When LAX defends you, it calls the *same
...
collateral is WETH and ETH's price falls, your collateral is worth less —
that's the scenario LAX defends against.
